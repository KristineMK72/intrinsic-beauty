  ...
  return (
    <main className="min-h-screen py-10">
      <Container>
        ...
        <div className="mt-6 lux-kicker">Scalp</div>
        <h1 className="mt-3 text-4xl font-semibold tracking-tight">Scalp therapy</h1>
        <p className="mt-3 text-black/65">
          Reset, hydrate, and restore balance.
        </p>
        ...
        <div className="mt-7">
          <Surface>
            ...
            <div className="mt-6 rounded-2xl border border-black/5 bg-white/60 p-4 text-sm text-black/65">
              Want the right treatment?{" "}
              <a className="underline font-semibold" href={`sms:+1${PHONE_TEL}`}>Text</a>{" "}
              your goals and we’ll suggest the best fit.
            </div>
          </Surface>
        </div>
      </Container>
