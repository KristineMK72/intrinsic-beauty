    ...
    <main>
      ...
      <div className="relative overflow-hidden border-b border-black/5">
        <div className="absolute inset-0">
          ...
          <div className="absolute -left-24 -top-24 h-80 w-80 rounded-full bg-black/5 blur-3xl" />
          <div className="absolute -right-24 top-24 h-80 w-80 rounded-full bg-black/5 blur-3xl" />
          {/* gold ring motif */}
          <div className="absolute left-1/2 top-12 h-72 w-72 -translate-x-1/2 rounded-full border border-[rgb(var(--ring))]/60" />
          <div className="absolute left-1/2 top-12 h-80 w-80 -translate-x-1/2 rounded-full border border-[rgb(var(--ring))]/30" />
        </div>
            ...
            <div className="flex flex-col gap-8">
              <div>
                ...
                <p className="mt-3 max-w-2xl text-base leading-relaxed text-black/70">
                  A warm, personal salon experience by <span className="font-semibold">Katherine Andrews</span>.
                  Fresh cuts, dimensional color, and scalp care — done with intention.
                </p>
                ...
                <div className="mt-6 text-sm text-black/60">
                  ...
                  <div className="mt-3 font-semibold text-black/70">Location</div>
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                ...
                <Card>
                  <div className="text-sm font-semibold">Scalp Therapy</div>
                  <div className="mt-1 text-sm text-black/60">
      ...
      <section id="services" className="py-12">
        <Container>
          <div className="flex items-end justify-between gap-6">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-black/60">
                Clear, simple pricing — just like your menu card. Taxes/tips not included unless noted.
              </p>
            </div>
            <a className="hidden text-sm underline sm:block" href={`tel:+1${PHONE_TEL}`}>
          ...
          <div className="mt-7 rounded-3xl border border-black/5 bg-white/60 p-5 text-sm text-black/70">
          ...
          <div className="grid gap-5 md:grid-cols-2">
            <Card>
              ...
              <p className="mt-3 text-sm leading-relaxed text-black/70">
                Intrinsic Beauty is owned and operated by <span className="font-semibold">Katherine Andrews</span>.
